...
function CaseCard({ title, metric, desc }: CaseCardProps) {
  return (
    <article className="rounded-2xl border border-cosmic-700/60 bg-cosmic-800/40 p-8 hover:bg-cosmic-800/60 transition-all duration-300 hover:border-cosmic-600/80 hover:shadow-2xl hover:shadow-cyan-500/10 group relative overflow-hidden">
      ...
      <div className="relative z-10">
        <h3 className="text-xl font-bold mb-3 group-hover:text-cyan-300 transition-colors duration-300 leading-tight">
          {title}
        </h3>
        <p className="text-cyan-400 font-semibold text-lg mb-4 group-hover:text-cyan-300 transition-colors duration-300">
          {metric}
        </p>
...
export default function HomePage() {
  return (
    <main className="relative">
      ...
      >
        ...
        <div className="relative z-10 text-center px-6 pt-24 pb-16 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link
              href="/werkwijze"
              className="px-8 py-4 border-2 border-gray-600 rounded-lg font-semibold text-lg hover:border-white hover:bg-white/10 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-cosmic-900"
            >
      ...
      <section aria-label="Cases" className="py-24 px-6 glass">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center leading-tight">
      ...
      <section aria-label="Process" className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-16 text-center leading-tight">
      ...
      <section aria-label="Call to action" className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link
              href="/contact"
              className="px-10 py-4 bg-gradient-to-r from-cyan-500 to-magenta-500 rounded-lg font-semibold text-lg hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/25 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-cosmic-900"
            >
              Plan een strategiesessie
            </Link>
            <Link
              href="/diensten"
              className="px-10 py-4 border-2 border-gray-600 rounded-lg font-semibold text-lg hover:border-white hover:bg-white/10 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-cosmic-900"
            >
